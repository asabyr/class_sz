...
# compatibility)
#PYTHON ?= python
PYTHON ?= /Users/asabyr/opt/anaconda3/envs/tSZ/bin/python
...
INCLUDES =-I../include -I/usr/local/include/ -I/Users/asabyr/opt/anaconda3/envs/tSZ/include/
...
class: $(TOOLS) $(SOURCE) $(EXTERNAL) $(OUTPUT) $(CLASS)
	#$(CC) $(OPTFLAG) $(OMPFLAG) $(LDFLAG) -g -o class $(addprefix build/,$(notdir $^)) -lm -L/home/runner/work/SOLikeT/SOLikeT/gsl-2.6/lib -lgsl -lgslcblas
	 ...
	 $(CC) $(OPTFLAG) $(OMPFLAG) $(LDFLAG) -g -o class $(addprefix build/,$(notdir $^)) -L/usr/local/lib -L/Users/asabyr/opt/anaconda3/envs/tSZ/lib/ -lgsl -lgslcblas -lfftw3 -lm
